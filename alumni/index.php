    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto my-2 my-lg-0">
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="empresa/login.html">Empresas</a>
          </li>
          <li class="nav-item">
    ...
    <div class="container h-100">
      <div class="row h-100 align-items-center justify-content-center text-center">
        ...
        <div class="col-lg-8 align-self-baseline">
          ...
          <a class="btn btn-primary btn-xl js-scroll-trigger" href="login.html">Entrar</a>
        </div>
      </div>
    </div>
  </header>
...
<div class="container">
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6 text-center">
          <div class="mt-5">
            ...
            <h3 class="h4 mb-2">Auxiliar Administrativo</h3>
            <p class="text-muted mb-0">Saiba Mais</p>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 text-center">
          <div class="mt-5">
            <i class="fas fa-4x fa-laptop-code text-primary mb-4"></i>
            <h3 class="h4 mb-2">Desenvolvedor FrontEnd</h3>
            <p class="text-muted mb-0">Saiba Mais</p>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 text-center">
        ...
        <div class="col-lg-3 col-md-6 text-center">
          <div class="mt-5">
            ...
            <h3 class="h4 mb-2">Estágio em pedagogia</h3>
            <p class="text-muted mb-0">Saiba Mais</p>
          </div>
        </div>
      </div>
  ...
  <footer class="bg-light py-5">
    <div class="container">
      ...
      <a href="logina.html">Área Administrativa</a>
    </div>
  </footer>
