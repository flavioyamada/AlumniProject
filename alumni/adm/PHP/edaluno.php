                        ...
                        <table id="datat" class="table table-hover table-bordered"><!--17-->
                            ...
                            While($consulta = mysqli_fetch_array($result)) {
                               ...
                               <td>$consulta[rua]</td>
                                ...
                                <td>
                                <a href='edaluno2.php?id_cadastro_cliente=$consulta[id_cadastro_cliente]'>Editar</a>
                                </td>
                                </tr>";
                            }
