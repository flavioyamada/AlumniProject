            ...
            <!-- #################################################################### -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form class="form-horizontal" action="PHP/cadastrovagas.php" method="post">
                            <div class="form-group">
                                <label class="control-label col-md-2" for="titulo">Titulo:</label>
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="input-group col-md-4">
                                    ...
                                    <input type="number" name="salario" id="salario" class="form-control" placeholder="R$" required="required" />
                                </div>
                            </div>
